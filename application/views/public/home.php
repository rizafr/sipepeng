...
<body class="homepage">
    ...
    <section id="main-slider" >
        <div class=" carousel slide" style="max-width: 1200px;  margin: 0 auto">
            ...
            <div class="carousel-inner">
                ...
                <div class="item" style="background-image: url(<?php echo base_url() ?>assets/public/images/slider/leuwigajah.jpg)">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-9">
                                <div class="carousel-content">
    ...
    <section id="gallery">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2>Galeri Hasil Pembangunan</h2>
            </div>
            <div class="row wow fadeInDown">
                <?php
                $no = 1;

                $jum = count(@$artesis_galeri);
                if ($jum > 0) {
                    foreach ($artesis_galeri as $row) {
                        ?>

                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="recent-work-wrap">
                                <img class="img-responsive" src=" <?php echo base_url() ?>assets/upload/foto/<?php echo $row->foto ?>" alt="">
                                <div class="overlay">
                                    <div class="recent-work-inner">
                                        <h2>Artesis </h2>
                                        <h3><?php echo "RT " . $row->rt . " RW " . $row->rw ?> </h3>
                                        <h4><?php echo "Alamat: " . $row->alamat ?></h4>
                                        <a class="preview" href=" <?php echo base_url() ?>assets/upload/foto/<?php echo $row->foto ?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View</a>
                                    </div> 
                                </div>
                            </div>
                        </div>  
                ...
                $jum = count(@$drainase_galeri);
                if ($jum > 0) {
                    foreach ($drainase_galeri as $row) {
                        ?>
                ...
                $jum = count(@$mck_galeri);
                if ($jum > 0) {
                    foreach ($mck_galeri as $row) {
                        ?>
                ...
                $jum = count(@$septictank_galeri);
                if ($jum > 0) {
                    foreach ($septictank_galeri as $row) {
                        ?>
                ...
                $jum = count(@$sumur_dangkal_galeri);
                if ($jum > 0) {
                    foreach ($sumur_dangkal_galeri as $row) {
                        ?>
                ...
                $jum = count(@$sumur_resapan_galeri);
                if ($jum > 0) {
                    foreach ($sumur_resapan_galeri as $row) {
                        ?>
                ...
                $jum = count(@$septictank_komunal_galeri);
                if ($jum > 0) {
                    foreach ($septictank_komunal_galeri as $row) {
                        ?>
                ...
                $jum = count(@$jalan_galeri);
                if ($jum > 0) {
                    foreach ($jalan_galeri as $row) {
                        ?>
                ...
                $jum = count(@$lain_galeri);
                if ($jum > 0) {
                    foreach ($lain_galeri as $row) {
                        ?>
    ...
    <script type="text/javascript">
                ...
                plotBackgroundColor: null,
                        ...
                        type: 'pie',
                                ...
                                name: 'MCK',
                                        ...
                                        ['Lain lain', <?php echo $lain_dilaksanakan ?>]
                                ]
                        }]
                });
                        //END GRAFIK TEREALISASI
                ...
                plotBackgroundColor: null,
                        ...
                        type: 'pie',
                                ...
                                name: 'MCK',
                                        ...
                                        ['Lain lain', <?php echo $lain_tidak_dilaksanakan ?>]
                                ]
                        }]
                });
                ...
                type: 'column'
                        ...
                        name: 'Lain lain',
                                data: [<?php echo $lain_awal ?>, <?php echo $lain_dilaksanakan ?>, <?php echo $lain_tidak_dilaksanakan ?>]
