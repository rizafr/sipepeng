                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
											<?php echo set_value('rt', isset($lain_list['rt']) ? $lain_list['rt'] : 'Belum Ada'); ?>
										</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
											<?php echo set_value('rw', isset($lain_list['rw']) ? $lain_list['rw'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
									
									<div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="rw">Nama Kegiatan: <span class="text-error">*</span></label>
                                        <div class="col-lg-10">
											<?php echo set_value('nama_kegiatan', isset($lain_list['nama_kegiatan']) ? $lain_list['nama_kegiatan'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
									...
									<div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo set_value('alamat', isset($lain_list['alamat']) ? $lain_list['alamat'] : 'Belum Ada'); ?>
										</div>
									</div><!--end form-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo set_value('ketersediaan_lahan', isset($lain_list['ketersediaan_lahan']) ? $lain_list['ketersediaan_lahan'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
											<?php echo set_value('long', isset($lain_list['long']) ? $lain_list['long'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
											<?php echo set_value('lat', isset($lain_list['lat']) ? $lain_list['lat'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo set_value('anggaran', isset($lain_list['anggaran']) ? $lain_list['anggaran'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
											<?php echo set_value('sumber_data', isset($lain_list['sumber_data']) ? $lain_list['sumber_data'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo set_value('tahun_usulan', isset($lain_list['tahun_usulan']) ? $lain_list['tahun_usulan'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
									...
									<div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo set_value('tahun_usulan', isset($lain_list['persetujuan_warga']) ? $lain_list['persetujuan_warga'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
									...
									<div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo set_value('ket', isset($lain_list['ket']) ? $lain_list['ket'] : 'Belum Ada'); ?>
										</div>
									</div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
										<? 
											$foto = isset($lain_list['foto']) ? $lain_list['foto'] : 'NULL';
											if($foto === NULL){
												$foto = 'noimage.jpg';
											}else{												
												$foto = $foto;
											...
											$dokumen = isset($lain_list['dokumen']) ? $lain_list['dokumen'] : 'NULL';
											if($dokumen === NULL){
												$dokumen = 'noimage.jpg';
											}else{												
												$dokumen = $dokumen;
									...
									<div class="form-group">
                                        ...
                                        <div class="col-lg-10">
											<a class="fancybox" rel="group" href="<?php echo base_url(); ?>assets/upload/dokumen/<?php echo $dokumen ?>"><button type="button" class="btn btn-shadow btn-primary"><?php echo set_value('dokumen', isset($lain_list['dokumen']) ? $lain_list['dokumen'] : 'Belum Ada'); ?></button></a>
