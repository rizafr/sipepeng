        ...
        <aside>
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li>
                        <a class="active" href="<?php echo base_url() ?>admin/state_managements">
                        ...
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <ul class="nav nav-tabs pull-right">
                                    <li><a href="<?php echo base_url() . 'admin/state_managements/gotoFormAdd'; ?>"><i class="icon-plus"></i> Add Data</a></li>
                                </ul>
                                <span class="hidden-sm wht-color">State Management</span>
                            </header>
                                        ...
                                        <tbody>
                                            <?php foreach ($states as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . 'admin/state_managements/edit/' . $row->id_state ?>"><button class = "btn btn-success" title="Edit"><i class = "icon-pencil"></i></button></a>
                                                        <a href="<?php echo base_url() . 'admin/state_managements/delete/' . $row->id_state ?>" onclick="return confirm('Are you sure want to delete this?');"><button class = "btn btn-danger" title="Delete"><i class = "icon-trash "></i></button></a>
                                                    </td>
                                                </tr>
                                            <?php }
                                            ?>
