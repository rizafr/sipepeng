                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/septictank_managements/process'); ?>" class="form-horizontal" id="validation-events" role="form" enctype="multipart/form-data">
                                    <input type="hidden" name="aksi" value="<? echo $aksi ?>" />
                                    <input type="hidden" name="id_septictank" value="<?php echo set_value('id_septictank', isset($septictank_list['id_septictank']) ? $septictank_list['id_septictank'] : ''); ?>" />
                                    <span class="help-inline"><?php echo form_error('id_septictank'); ?></span>
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="rt">RT: <span class="text-error">*</span></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="rt" name="rt" placeholder="RT" value="<?php echo set_value('rt', isset($septictank_list['rt']) ? $septictank_list['rt'] : ''); ?>"  data-validation="number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="rw" name="rw" placeholder="RW" value="<?php echo set_value('rw', isset($septictank_list['rw']) ? $septictank_list['rw'] : ''); ?>"  data-validation="number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="alamat" name="alamat" data-validation="length" data-validation-length="min10"><?php echo set_value('alamat', isset($septictank_list['alamat']) ? $septictank_list['alamat'] : ''); ?></textarea>                                           
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">											
                                            ...
                                            echo form_dropdown('ketersediaan_lahan', $options, set_value('ketersediaan_lahan', isset($septictank_list['ketersediaan_lahan']) ? $septictank_list['ketersediaan_lahan'] : ''), 'class="form-control m-bot15"');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="long" name="long" placeholder=Longitude" value="<?php echo set_value('long', isset($septictank_list['long']) ? $septictank_list['long'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="lat" name="lat" placeholder="Latitude" value="<?php echo set_value('lat', isset($septictank_list['lat']) ? $septictank_list['lat'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <div data-date-minviewmode="years" data-date-viewmode="years" data-date-format=" yyyy" data-date="102/2012"  class="input-append date dpYears">
                                                <input type="text" class="form-control" id="tahun_usulan" name="tahun_usulan" placeholder="Silakan isi tahun Usulan" value="<?php echo set_value('tahun_usulan', isset($septictank_list['tahun_usulan']) ? $septictank_list['tahun_usulan'] : ''); ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">											
                                            ...
                                            echo form_dropdown('persetujuan_warga', $options, set_value('persetujuan_warga', isset($septictank_list['persetujuan_warga']) ? $septictank_list['persetujuan_warga'] : ''), 'class="form-control m-bot15"');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="ket" name="ket"> <?php echo set_value('ket', isset($septictank_list['ket']) ? $septictank_list['ket'] : ''); ?></textarea>                                           
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="hidden" class="form-control" id="foto_old" name="foto_old" placeholder="Foto" value="<?php echo $septictank_list['foto'] ?>" >
