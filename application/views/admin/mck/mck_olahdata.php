                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/mck_managements/process'); ?>" class="form-horizontal" id="validation-events" role="form" enctype="multipart/form-data">
								<input type="hidden" name="aksi" value="<? echo $aksi ?>" />
								<input type="hidden" name="id_mck" value="<?php echo set_value('id_mck', isset($mck_list['id_mck']) ? $mck_list['id_mck'] : ''); ?>" />
                                     <span class="help-inline"><?php echo form_error('id_mck'); ?></span>
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="rt">RT: <span class="text-error">*</span></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="rt" name="rt" placeholder="RT" value="<?php echo set_value('rt', isset($mck_list['rt']) ? $mck_list['rt'] : ''); ?>"  data-validation="number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="rw" name="rw" placeholder="RW" value="<?php echo set_value('rw', isset($mck_list['rw']) ? $mck_list['rw'] : ''); ?>"  data-validation="number">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="alamat" name="alamat" data-validation="length" data-validation-length="min10"><?php echo set_value('alamat', isset($mck_list['alamat']) ? $mck_list['alamat'] : ''); ?></textarea>                                           
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="ketersediaan_lahan" name="ketersediaan_lahan" placeholder="Ketersediaan Lahan" value=" <?php echo set_value('ketersediaan_lahan', isset($mck_list['ketersediaan_lahan']) ? $mck_list['ketersediaan_lahan'] : ''); ?>">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="long" name="long" placeholder=Longitude" value="<?php echo set_value('long', isset($mck_list['long']) ? $mck_list['long'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="lat" name="lat" placeholder="Latitude" value="<?php echo set_value('lat', isset($mck_list['lat']) ? $mck_list['lat'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">                                               	  
                                            <input type="text" class="form-control" id="anggaran" name="anggaran" placeholder="Silakan isi anggaran" value="<?php echo set_value('anggaran', isset($mck_list['anggaran']) ? $mck_list['anggaran'] : ''); ?>">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                         ...
                                         <input type="text" class="form-control" id="tahun_usulan" name="tahun_usulan" placeholder="Silakan isi tahun Usulan" value="<?php echo set_value('tahun_usulan', isset($mck_list['tahun_usulan']) ? $mck_list['tahun_usulan'] : ''); ?>" readonly>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">											
											 <?php 
												 ...
												 echo form_dropdown('persetujuan_warga', $options, set_value('persetujuan_warga', isset($mck_list['persetujuan_warga']) ? $mck_list['persetujuan_warga'] : ''), 'class="form-control m-bot15"'); ?>
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                           <textarea class="form-control" id="ket" name="ket"> <?php echo set_value('ket', isset($mck_list['ket']) ? $mck_list['ket'] : ''); ?></textarea>                                           
