                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <div class="col-lg-10">                                           
                                            ...
                                            <a href="<?php echo base_url() . 'admin/mck_managements/cetak_detail/' . $mck_list['id_mck'] ?>"><button type="button" class="btn btn-primary"><i class=" icon-print"></i> Print Data Detail</button></a>
                                        </div>
                                    </div><!--end control-group-->
