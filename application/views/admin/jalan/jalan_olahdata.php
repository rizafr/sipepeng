                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/jalan_managements/process'); ?>" class="form-horizontal" id="validation-events" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="lat_akhir" name="lat_akhir" placeholder="Latitude Akhir" value="<?php echo set_value('lat_akhir', isset($jalan_list['lat_akhir']) ? $jalan_list['lat_akhir'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="hidden" class="form-control" id="foto_old" name="foto_old" placeholder="Foto" value="<?php echo $jalan_list['foto'] ?>" >
