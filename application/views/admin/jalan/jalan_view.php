                                ...
                                <form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10">                                           
                                            ...
                                            <a href="<?php echo base_url() . 'admin/jalan_managements/cetak/' . $jalan_list['id_jalan'] ?>"><button type="button" class="btn btn-info "><i class=" icon-print"></i> Print Data Usulan</button></a>
                                            <a href="<?php echo base_url() . 'admin/jalan_managements/cetak_detail/' . $jalan_list['id_jalan'] ?>"><button type="button" class="btn btn-primary"><i class=" icon-print"></i> Print Data Detail</button></a>
                                        </div>
                                    </div><!--end control-group-->                                    
