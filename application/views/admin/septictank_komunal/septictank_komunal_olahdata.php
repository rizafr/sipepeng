								...
								<input type="hidden" name="id_septictank_komunal" value="<?php echo set_value('id_septictank_komunal', isset($septictank_komunal_list['id_septictank_komunal']) ? $septictank_komunal_list['id_septictank_komunal'] : ''); ?>" />
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="sumber_data" name="sumber_data" placeholder="Silakan isi Sumber Data" value="<?php echo set_value('sumber_data', isset($septictank_komunal_list['sumber_data']) ? $septictank_komunal_list['sumber_data'] : ''); ?>" data-validation-help="Sumber data sumur dangkal berasal darimana">
