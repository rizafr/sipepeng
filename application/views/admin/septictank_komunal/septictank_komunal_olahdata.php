                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/septictank_komunal_managements/process'); ?>" class="form-horizontal" id="validation-events" role="form" enctype="multipart/form-data">
                                    <input type="hidden" name="aksi" value="<? echo $aksi ?>" />
                                    <input type="hidden" name="id_septictank_komunal" value="<?php echo set_value('id_septictank_komunal', isset($septictank_komunal_list['id_septictank_komunal']) ? $septictank_komunal_list['id_septictank_komunal'] : ''); ?>" />
                                    <span class="help-inline"><?php echo form_error('id_septictank_komunal'); ?></span>
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="rt">RT: <span class="text-error">*</span></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="rt" name="rt" placeholder="RT" value="<?php echo set_value('rt', isset($septictank_komunal_list['rt']) ? $septictank_komunal_list['rt'] : ''); ?>"  data-validation="number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="rw" name="rw" placeholder="RW" value="<?php echo set_value('rw', isset($septictank_komunal_list['rw']) ? $septictank_komunal_list['rw'] : ''); ?>"  data-validation="number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="alamat" name="alamat" data-validation="length" data-validation-length="min10"><?php echo set_value('alamat', isset($septictank_komunal_list['alamat']) ? $septictank_komunal_list['alamat'] : ''); ?></textarea>                                           
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">											
                                            ...
                                            echo form_dropdown('ketersediaan_lahan', $options, set_value('ketersediaan_lahan', isset($septictank_komunal_list['ketersediaan_lahan']) ? $septictank_komunal_list['ketersediaan_lahan'] : ''), 'class="form-control m-bot15"');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="long" name="long" placeholder=Longitude" value="<?php echo set_value('long', isset($septictank_komunal_list['long']) ? $septictank_komunal_list['long'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="lat" name="lat" placeholder="Latitude" value="<?php echo set_value('lat', isset($septictank_komunal_list['lat']) ? $septictank_komunal_list['lat'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">                                               	  
                                            <input type="text" class="form-control" id="anggaran" name="anggaran" placeholder="Silakan isi anggaran" value="<?php echo set_value('anggaran', isset($septictank_komunal_list['anggaran']) ? $septictank_komunal_list['anggaran'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="sumber_data" name="sumber_data" placeholder="Silakan isi Sumber Data" value="<?php echo set_value('sumber_data', isset($septictank_komunal_list['sumber_data']) ? $septictank_komunal_list['sumber_data'] : ''); ?>" data-validation-help="Sumber data septictank  komunal berasal darimana">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">
                                            <div data-date-minviewmode="years" data-date-viewmode="years" data-date-format=" yyyy" data-date="102/2012"  class="input-append date dpYears">
                                                <input type="text" class="form-control" id="tahun_usulan" name="tahun_usulan" placeholder="Silakan isi tahun Usulan" value="<?php echo set_value('tahun_usulan', isset($septictank_komunal_list['tahun_usulan']) ? $septictank_komunal_list['tahun_usulan'] : ''); ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">											
                                            ...
                                            echo form_dropdown('persetujuan_warga', $options, set_value('persetujuan_warga', isset($septictank_komunal_list['persetujuan_warga']) ? $septictank_komunal_list['persetujuan_warga'] : ''), 'class="form-control m-bot15"');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="jml_pemakai" name="jml_pemakai" placeholder="Jumlah Pemakai" value="<?php echo set_value('jml_pemakai', isset($septictank_komunal_list['jml_pemakai']) ? $septictank_komunal_list['jml_pemakai'] : ''); ?>"  data-validation="number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" id="ket" name="ket"> <?php echo set_value('ket', isset($septictank_komunal_list['ket']) ? $septictank_komunal_list['ket'] : ''); ?></textarea>                                           
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="hidden" class="form-control" id="foto_old" name="foto_old" placeholder="Foto" value="<?php echo $septictank_komunal_list['foto'] ?>" >
