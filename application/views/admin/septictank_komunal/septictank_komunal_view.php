                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10">                                           
                                            <button type="button" class="btn btn-default " onclick="history.go(-1);"><i class=" icon-chevron-sign-left"></i> Kembali</button>
                                             <a href="<?php echo base_url() . 'admin/septictank_komunal_managements/cetak_detail/' . $septictank_komunal_list['id_septictank_komunal'] ?>"><button type="button" class="btn btn-primary"><i class=" icon-print"></i> Print Data Detail</button></a>
                                        </div>
                                    </div><!--end control-group-->
