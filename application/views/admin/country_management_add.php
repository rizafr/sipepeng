                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <span class="hidden-sm wht-color">Add Country</span>
                            </header>
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/country_managements/process_add/add'); ?>" class="form-horizontal" role="form">

                                    <legend>&nbsp;&nbsp;&nbsp;&nbsp;1. Country Informations</legend>
                                    
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="inputCountryName">Country Name: <span class="text-error">*</span></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputStateName" name="country_name" placeholder="Country Name" value="<?php echo set_value('country_name'); ?>">
