                        ...
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <ul class="nav nav-tabs pull-right">
                                    <li><a href="<?php echo base_url() . 'admin/category_managements/gotoFormAdd'; ?>"><i class="icon-plus"></i> Add Data</a></li>
                                </ul>
                                <span class="hidden-sm wht-color">Product Category Management</span>
                            </header>
                                        ...
                                        <tbody>
                                            <?php foreach ($categories as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . 'admin/category_managements/edit/' . $row->id_category ?>"><button class = "btn btn-success" title="Edit"><i class = "icon-pencil"></i></button></a>
                                                        <a href="<?php echo base_url() . 'admin/category_managements/delete/' . $row->id_category ?>" onclick="return confirm('Are you sure want to delete this?');"><button class = "btn btn-danger" title="Delete"><i class = "icon-trash "></i></button></a>
                                                    </td>
                                                </tr>
                                            <?php }
                                            ?>
