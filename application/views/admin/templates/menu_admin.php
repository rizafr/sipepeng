                    ...
                    <li class="sub-menu" >
                        ...
                        <ul class="sub">
                             <?php foreach ($menu_list as $row) { ?>
                              <li <? $page=$row->controller; $url=$this->uri->segment(2);$page=(explode("/",$page));echo ($page[0]==$url ? " class='active' " : '') ?>><a  href="<?php echo base_url() ?><?php echo $row->controller ?>/index/1" ><?php echo $row->menu ?></a></li>
                             <? } ?>
                       </ul>
                    </li>      
