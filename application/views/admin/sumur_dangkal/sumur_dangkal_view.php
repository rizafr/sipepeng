                                ...
                                <form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10">                                           
                                            ...
                                            <a href="<?php echo base_url() . 'admin/sumur_dangkal_managements/cetak/' . $sumur_dangkal_list['id_sumur_dangkal'] ?>"><button type="button" class="btn btn-info "><i class=" icon-print"></i> Print Data Usulan</button></a>
                                            <a href="<?php echo base_url() . 'admin/sumur_dangkal_managements/cetak_detail/' . $sumur_dangkal_list['id_sumur_dangkal'] ?>"><button type="button" class="btn btn-primary"><i class=" icon-print"></i> Print Data Detail</button></a>
                                        </div>
                                    </div><!--end control-group-->
