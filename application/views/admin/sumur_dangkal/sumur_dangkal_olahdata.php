                                ...
                                <form method="post" action="<?php echo base_url('admin/sumur_dangkal_managements/process'); ?>" class="form-horizontal" id="validation-events" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3 col-xs-11">											
                                            ...
                                            echo form_dropdown('ketersediaan_lahan', $options, set_value('ketersediaan_lahan', isset($sumur_dangkal_list['ketersediaan_lahan']) ? $sumur_dangkal_list['ketersediaan_lahan'] : ''), 'class="form-control m-bot15"');
                                            ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="hidden" class="form-control" id="foto_old" name="foto_old" placeholder="Foto" value="<?php echo $sumur_dangkal_list['foto'] ?>" >
