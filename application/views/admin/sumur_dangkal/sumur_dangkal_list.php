														...
														<tr>
															...
															<td>
																<? 
																	...
																	<a href="<?php echo base_url() . 'admin/sumur_dangkal_managements/update_status_tidak_dilaksanakan/' . $row->id_sumur_dangkal ?>"><button class = "btn btn-danger" data-toggle="tooltip" title="Tolak" data-placemen="bottom"><i class = "icon-remove-circle"></i></button></a>
