                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/state_managements/process'); ?>" class="form-horizontal" role="form">

                                    <legend>&nbsp;&nbsp;&nbsp;&nbsp;1. State Informations</legend>
                                    
                                    <div class="form-group">
                                        <label class="col-lg-2 col-sm-2 control-label" for="inputStateName">State Name: <span class="text-error">*</span></label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputStateName" name="state" placeholder="State Name" value="<?php echo set_value('state', isset($states['state']) ? $states['state'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10">
                                            <input type="hidden" name="id_state" value="<?php echo $idState ?>">
                                            <br>
