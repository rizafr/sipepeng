                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <span class="hidden-sm wht-color">Data Pangkalan Gas LPG <? echo $judul; ?> </span>
                            </header>
                                                    ...
                                                    foreach ($data_list as $row) {
                                                        ...
                                                        <tr>
															...
															<td>
                                                                ...
                                                                <a href="<?php echo base_url() . 'admin/gas_managements/delete/' . $row->id_gas . '/' . $status ?>" onclick="return confirm('Are you sure want to delete this?');"><button class = "btn btn-danger" title="Delete"><i class = "icon-trash "></i></button></a>
                                                            </td>
