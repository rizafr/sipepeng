                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <div class="col-lg-10">                                           
                                            ...
                                            <a href="<?php echo base_url() . 'admin/sumur_resapan_managements/cetak_detail/' . $sumur_resapan_list['id_sumur_resapan'] ?>"><button type="button" class="btn btn-primary"><i class=" icon-print"></i> Print Data Detail</button></a>
                                        </div>
                                    </div><!--end control-group-->
