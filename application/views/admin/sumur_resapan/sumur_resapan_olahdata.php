								...
								<input type="hidden" name="id_sumur_resapan" value="<?php echo set_value('id_sumur_resapan', isset($sumur_resapan_list['id_sumur_resapan']) ? $sumur_resapan_list['id_sumur_resapan'] : ''); ?>" />
                                  ...
                                  <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="ketersediaan_lahan" name="ketersediaan_lahan" placeholder="Ketersediaan Lahan" value=" <?php echo set_value('ketersediaan_lahan', isset($sumur_resapan_list['ketersediaan_lahan']) ? $sumur_resapan_list['ketersediaan_lahan'] : ''); ?>" data-validation="number" data-validation-allowing="float" data-validation-help="satuan dalam meter,gunakan titik misalnya 0.3">
