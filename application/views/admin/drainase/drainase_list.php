                            ...
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <?php if ($status == '1') { ?>
                                    <ul class="nav nav-tabs pull-right">
                                        <li><a href="<?php echo base_url() . 'admin/drainase_managements/gotoForm/add'; ?>"><i class="icon-plus"></i> Add Data</a></li>
                                    </ul>
                                    <?
                                }
                                                ...
                                                if ($jum > 0) {
                                                    ...
                                                    if ($status == '3') {
                                                            ...
                                                            <td>
                                                                ...
                                                                if ($status == '1') {
                                                                    ?>
                                                                    <a href="<?php echo base_url() . 'admin/drainase_managements/update_status_data_awal/' . $row->id_drainase ?>"><button class = "btn btn-success" data-toggle="tooltip" title="Verifikasi" data-placemen="bottom"><i class = "icon-ok"></i></button></a>
                                                                <?
                                                                }
                                                                if ($status == '2') {
                                                                    ?>
                                                                    <a href="<?php echo base_url() . 'admin/drainase_managements/update_status_verifikasi/' . $row->id_drainase ?>"><button class = "btn btn-success" data-toggle="tooltip" title="Progress" data-placemen="bottom"><i class = "icon-ok"></i></button></a>
                                                                    <a href="<?php echo base_url() . 'admin/drainase_managements/update_status_tidak_dilaksanakan/' . $row->id_drainase ?>"><button class = "btn btn-danger" data-toggle="tooltip" title="Tolak" data-placemen="bottom"><i class = "icon-remove-circle"></i></button></a>
                                                                <?
                                                                }
                                                                if ($status == '3') {
                                                                    ?>
                                                                    <a href="<?php echo base_url() . 'admin/drainase_managements/update_status_sedang_dilaksanakan/' . $row->id_drainase ?>"><button class = "btn btn-success" data-toggle="tooltip" title="Sudah Dilaksanakan" data-placemen="bottom"><i class = "icon-ok"></i></button></a>
        <? }
        ?>		
