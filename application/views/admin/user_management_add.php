                            ...
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/user_managements/process_add/add'); ?>" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputUserName" name="user_name" placeholder="Username" value="<?php echo set_value('user_name'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputEmailAddress" name="user_email" placeholder="example@example.com" value="<?php echo set_value('user_email'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputTele" name="user_phone" placeholder="(02)-1598-548" value="<?php echo set_value('user_phone'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo form_dropdown('id_status', $level_list, set_value('id_status'), 'class="form-control m-bot15"'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputFirstAdd" name="first_address" placeholder="First Address" value="<?php echo set_value('first_address'); ?>">
                                            <span class="help-inline"><?php echo form_error('user_phone'); ?></span>
                                        </div>
                                    </div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputSecondAdd" name="second_address" placeholder="Second Address" value="<?php echo set_value('second_address'); ?>">
                                        </div>
                                    </div><!--end control-group-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputCity" name="user_city" placeholder="City" value="<?php echo set_value('user_city'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputPostCode" name="user_zip" placeholder="Zip Code" value="<?php echo set_value('user_zip'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo form_dropdown('id_country', $country_list, set_value('id_country'), 'class="form-control m-bot15"'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <?php echo form_dropdown('id_state', $states_list, set_value('id_state'), 'class="form-control m-bot15"'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="password" class="form-control" id="inputPass" name="user_password" placeholder="**********" value="<?php echo set_value('user_password'); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="password" class="form-control" id="inputConPass" name="confirm_password" placeholder="**********" value="<?php echo set_value('confirm_password'); ?>">
