                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                                <span class="hidden-sm wht-color">Edit Data Country</span>
                            </header>
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url('admin/country_managements/process'); ?>" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" id="inputCountryName" name="country_name" placeholder="Country Name" value="<?php echo set_value('country_name', isset($countries['country_name']) ? $countries['country_name'] : ''); ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10">
                                            <input type="hidden" name="id_country" value="<?php echo $idCountry ?>">
                                            <br>
