...
class Perusahaan_model extends CI_Model {
	...
	public function select_all() {
		$sql = "select * from ekonomi_nama_perusahaan";
	...
	public function search_all($keyword) {
		$sql = "select * from ekonomi_nama_perusahaan where nama_perusahaan like '%" . $keyword . "%'";
		return $this->db->query($sql);
	}
	...
	public function add($data) {
		...
		return $this->db->insert('ekonomi_nama_perusahaan', $data);
	}
	
	//update user    
	public function update($id_nama_perusahaan) {
		$data = array(
		...
		$this->db->where('id_nama_perusahaan', $id_nama_perusahaan);
		return $this->db->update('ekonomi_nama_perusahaan', $data);
	}
	
	public function getekonomi_nama_perusahaanById($id_nama_perusahaan) {
		$this->db->select('*');
		$this->db->where('id_nama_perusahaan', $id_nama_perusahaan);
		$query = $this->db->get('ekonomi_nama_perusahaan', 1);
	...
	//delete
	public function delete($id_nama_perusahaan) {
		$this->db->delete('ekonomi_nama_perusahaan', array('id_nama_perusahaan' => $id_nama_perusahaan));
	}
